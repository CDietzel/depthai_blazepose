...
def recognize_gesture(b):
    ...
    right_arm_angle = angle_with_y(
        b.landmarks[KEYPOINT_DICT["right_elbow"], :2]
        - b.landmarks[KEYPOINT_DICT["right_shoulder"], :2]
    )
    left_arm_angle = angle_with_y(
        b.landmarks[KEYPOINT_DICT["left_elbow"], :2]
        - b.landmarks[KEYPOINT_DICT["left_shoulder"], :2]
    )
