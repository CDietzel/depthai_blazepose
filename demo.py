...
parser_tracker.add_argument(
    "--pd_m", type=str, help="Path to an .blob file for pose detection model"
)
parser_tracker.add_argument(
    "--lm_m",
    type=str,
...
parser_tracker.add_argument(
    "--no_smoothing", action="store_true", help="Disable smoothing filter"
)
parser_tracker.add_argument(
    "-f",
    "--internal_fps",
...
parser_tracker.add_argument(
    "-s", "--stats", action="store_true", help="Print some statistics at exit"
)
parser_tracker.add_argument(
